                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>We provide a platform for buyers and sellers to connect with each other and find the deserving home. <marquee behavior="" direction=""></marquee></p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>We offer rental services for students, travllers and visitors, there is a big library of hostels, airbnbs and paying guest rooms.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Listed properties can be bought or rented with contacting the seller and owner with a agent.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>A finance agent or a real estate agent can help benefit the buyer invest in real estate for investing programs.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-6">
                        <div class="living-list pr-4">
                            <h3 class="pb-4 mb-3 text-white">Why Trust Us</h3>
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-reward flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Experience Quality</h5>
										<p>We offer professional counseling and provide best in calls user experience with seamless and smooth transaction and exchange of properties.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-real-estate flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Authenticate and Verified Properties</h5>
										<p>We confirm and check every listing on our website with real estate agents in our firm to ensure the information and the offer is valid and legal in all terms.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-seller flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Data Privacy and Security</h5>
										<p>We keep records of all transaction and listing and their legal documents incase of any injustice or misbehaviour from any seller or buyer, ensuring a trustful and simple platform that prevents cheat and fraud from disturbing the platform.</p>
									</div>
                                </li>
                            </ul>
                        </div>
